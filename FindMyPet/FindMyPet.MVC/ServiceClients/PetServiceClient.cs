...
namespace FindMyPet.MVC.ServiceClients
{
    public interface IPetServiceClient
    {
        ...
        string CreateSharePetToken(PetShareCreateRequest request);
        int ConfirmSharePet(PetShareConfirmRequest request);
        ...
        int SetPetImageAsDefault(PetImageSetAsDefaultRequest request);
        int DeletePetImage(PetImageDeleteRequest request);
    }
    ...
    public class PetServiceClient : IPetServiceClient
    {
        ...
        public int DeletePetImage(PetImageDeleteRequest request)
        {
            var response = _findMyPetClient.JsonClient().Delete(request);
